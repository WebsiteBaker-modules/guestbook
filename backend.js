...
/** jQuery textarea autogrow plugin (-- changeset r10)
...
$.fn.growfield = function( options ) {
    this.each( function() {
        ...
        this._changeSize = function( to, event ) {
            ...
            return this._animate( Math.min(txt.height(), txt.get(0).offsetHeight), to, event, ovr);
        };
        ...
        this._createDummy = function() {
            ...
            while (i) {
                this.gf.dummy = txt.clone().css({position:'absolute', left:-9999, top:0, visibility: 'hidden', width: txt.get(0).offsetWidth}).
                                                         attr('tabindex', -9999).attr('__growfieldDummy', '1').attr('name', '');
