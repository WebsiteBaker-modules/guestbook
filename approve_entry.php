...
// Get ID
if (isset($_GET['entry_id']) AND is_numeric($_GET['entry_id']) AND isset($_GET['approve']) AND is_numeric($_GET['approve'])) {
	$id = $_GET['entry_id'];
...
// Set approval value in database based upon what was passed in the approve GET string
$database->query("UPDATE `".TABLE_PREFIX."mod_guestbook` SET `approved` = '$approve' WHERE `id` ='$id'");
